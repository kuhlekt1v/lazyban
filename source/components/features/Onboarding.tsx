...
import {ConfirmPrompt} from './index.js';
import {TextInput, SelectInput} from '../shared/index.js';
import {
	createBoardDirectory,
	createConfigFile,
	createBoardFile,
} from '../../core/config/fs.js';
import {BoardConfig, provider, theme} from '../../core/models.js';
...
const Onboarding = ({onComplete, onCancel}: Props) => {
